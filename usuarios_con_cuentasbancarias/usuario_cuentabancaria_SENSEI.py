...
annie.deposit_amount(200,"main_account").deposit_amount(1000,"savings_account").take_money(800, "savings_account").show_balance("main_account").show_balance("savings_account")
